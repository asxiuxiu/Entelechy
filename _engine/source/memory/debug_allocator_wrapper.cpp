...
DebugAllocatorWrapper::DebugAllocatorWrapper(IAllocator* inner)
    : m_inner(inner) {
}
...
// Global allocator factory --------------------------------------------------
    ...
    IAllocator* GetGlobalAllocator() { return &g_debugAlloc; }
#else
    static DefaultAllocatorV g_defaultAllocV;
    IAllocator* GetGlobalAllocator() { return &g_defaultAllocV; }
#endif
