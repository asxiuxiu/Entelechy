...
{
    // Vec2
    registerType(TypeDesc{.name = "Vec2"_sid,
                          .size = sizeof(f32) * 2,
    ...
    // Vec3
    registerType(TypeDesc{.name = "Vec3"_sid,
                          .size = sizeof(f32) * 3,
                          .alignment = alignof(f32),
                          .kind = TypeKind::Composite,
                          .fields = {
    ...
    // Vec4
    registerType(TypeDesc{.name = "Vec4"_sid,
                          .size = sizeof(f32) * 4,
                          .alignment = alignof(f32),
                          .kind = TypeKind::Composite,
                          .fields = {
    ...
    // Quat
    registerType(TypeDesc{.name = "Quat"_sid,
                          .size = sizeof(f32) * 4,
                          .alignment = alignof(f32),
                          .kind = TypeKind::Composite,
                          .fields = {
    ...
    registerType(TypeDesc{.name = "Mat4"_sid,
                          .size = sizeof(f32) * 16,
                          .alignment = alignof(f32),
                          .kind = TypeKind::Composite,
                          .fields = {
    ...
    // Entity
    registerType(TypeDesc{.name = "Entity"_sid,
                          .size = sizeof(u32) * 2,
    ...
    // Color
    registerType(TypeDesc{.name = "Color"_sid,
                          .size = sizeof(f32) * 3,
                          .alignment = alignof(f32),
                          .kind = TypeKind::Composite,
                          .fields = {
