...
struct PipelineStateDesc
{
    ...
    bool operator==(const PipelineStateDesc &other) const
    {
        ...
        if (blendState.enable != other.blendState.enable)
            return false;
        if (blendState.srcFactor != other.blendState.srcFactor)
            return false;
        if (blendState.dstFactor != other.blendState.dstFactor)
            return false;
        if (blendState.op != other.blendState.op)
            return false;
        if (blendState.srcAlphaFactor != other.blendState.srcAlphaFactor)
            return false;
        if (blendState.dstAlphaFactor != other.blendState.dstAlphaFactor)
            return false;
        if (blendState.alphaOp != other.blendState.alphaOp)
            return false;
        if (depthStencilState.depthTest != other.depthStencilState.depthTest)
            return false;
        if (depthStencilState.depthWrite != other.depthStencilState.depthWrite)
            return false;
        if (depthStencilState.depthFunc != other.depthStencilState.depthFunc)
            return false;
        if (rasterizerState.fillMode != other.rasterizerState.fillMode)
            return false;
        if (rasterizerState.cullMode != other.rasterizerState.cullMode)
            return false;
        if (rasterizerState.frontFace != other.rasterizerState.frontFace)
            return false;
        return true;
    }
    bool operator!=(const PipelineStateDesc &other) const
