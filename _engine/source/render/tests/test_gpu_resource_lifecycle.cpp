...
public:
    ...
    IRHICommandList* createCommandList() override { return nullptr; }
    void submit(IRHICommandList* /*cmdList*/) override {}
    void present() override {}

    RHIFenceValue signalFrame() override { return currentFrame++; }
    RHIFenceValue getCompletedFenceValue() override { return completedFrame; }
    ...
    RHIMemoryInfo queryMemoryInfo() const override { return {}; }
    u64 getTrackedMemoryUsage() const override { return trackedMemory; }
    RenderBackendType getBackendType() const override { return RenderBackendType::OpenGL; }
};

class MockTexture : public RHITexture {
public:
    MockTexture(u64 size, const TextureDesc& desc)
        : m_size(size), m_desc(desc) {
    }
    ~MockTexture() override = default;

    const TextureDesc& getDesc() const override { return m_desc; }
    u64 memorySizeBytes() const override { return m_size; }
