...
SparseSet::SparseSet(IAllocator *allocator) : m_allocator(allocator) {}
...
SparseSet::SparseSet(SparseSet &&other) noexcept
    : m_allocator(other.m_allocator), m_pages(std::move(other.m_pages)), m_dense(std::move(other.m_dense))
{
}
