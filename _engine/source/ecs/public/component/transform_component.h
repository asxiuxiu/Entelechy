...
REFLECT_COMPONENT(Transform, REG_FIELD(Transform, translation, Vec3), REG_FIELD(Transform, rotation, Quat),
...
REFLECT_COMPONENT(GlobalTransform, REG_FIELD(GlobalTransform, matrix, Mat4))
