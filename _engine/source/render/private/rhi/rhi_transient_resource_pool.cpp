...
RHITextureRef TransientTexturePool::acquire(IRHIDevice* device, const TextureDesc& desc,
    ...
    for (auto& group : m_groups) {
        if (!descMatches(group.desc, desc)) continue;
...
void TransientTexturePool::release(RHITexture* texture, const TextureDesc& desc,
