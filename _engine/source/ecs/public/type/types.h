...
REFLECT_COMPONENT(Position, REG_FIELD(Position, x, f32), REG_FIELD(Position, y, f32))
...
REFLECT_COMPONENT(Velocity, REG_FIELD(Velocity, vx, f32), REG_FIELD(Velocity, vy, f32))
...
REFLECT_COMPONENT(Health, REG_FIELD(Health, hp, f32))
...
REFLECT_COMPONENT(ChildOf, REG_FIELD(ChildOf, parent, Entity))
...
REFLECT_COMPONENT(Color, REG_FIELD(Color, r, f32), REG_FIELD(Color, g, f32), REG_FIELD(Color, b, f32))
