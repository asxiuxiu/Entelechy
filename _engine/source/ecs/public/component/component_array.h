...
public:
    ...
    [[nodiscard]] virtual ComponentHooks *getHooks()
    {
        return nullptr;
    }
};
...
public:
    ...
    Column(Column &&other) noexcept
        : m_allocator(other.m_allocator), m_data(other.m_data), m_count(other.m_count), m_capacity(other.m_capacity)
    {
...
public:
    ...
    [[nodiscard]] ComponentHooks *getHooks() override
    {
        return m_hooks;
    }
    void setHooks(ComponentHooks *hooks)
    {
        m_hooks = hooks;
    }
